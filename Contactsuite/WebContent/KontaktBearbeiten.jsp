			...
			<div id="content">
				<div id="mainContent">
					<div id="kontaktForms">
						<div id="errorForm">
							...
							<div id="errorFormSelect">
								...
								<ul id="errorOl">
									...
									<li id="errorVorname" class="error"><span>Bitte
											tragen Sie den <b>Vornamen</b> ein.
									</span></li>

									<li id="errorNachname" class="error"><span>Bitte
											tragen Sie den <b>Nachname</b> ein.
									</span></li>

									<li id="errorStrasse" class="error"><span>Bitte
											tragen Sie die <b>Strasse</b> ein.
									</span></li>

									<li id="errorHn" class="error"><span>Bitte tragen
											Sie die <b>Hausnummer</b> ein.
									</span></li>

									<li id="errorPlz" class="error"><span>Bitte tragen
											Sie die <b>Postleizahl</b> ein.
									</span></li>

									<li id="errorPlzG" class="error"><span>Bitte tragen
											Sie die G�LTIGE <b>Postleizahl</b> ein (z.b. 59329).
									</span></li>
									...
									<li id="errorTn" class="error"><span>Bitte tragen
											Sie die <b>Telefonnummer</b> ein.
									</span></li>

									<li id="errorTnG" class="error"><span>Bitte tragen
											Sie die G�LTIGE <b>Telefonnummer</b> ein.
									</span></li>

									<li id="errorEmail" class="error"><span>Bitte
											tragen Sie die <b>E-Mail Adresse</b> ein.
									</span></li>

									<li id="errorEmailG" class="error"><span>Bitte
											tragen Sie die G�LTIGE <b>E-Mail</b> Adresse ein.
									</span></li>
						...
						<%
							if (typ.equals("privat")) {
								out.println("<form id=\"kontaktForm\" name=\"Eingabe\" action=\"Controller?fcode=PrivatkontaktSpeichern\" method=\"post\">");
							} else if (typ.equals("firma")) {
								out.println("<form id=\"kontaktForm\" name=\"Eingabe\" action=\"Controller?fcode=FirmenkontaktSpeichern\" method=\"post\">");
							}
						%>
						...
						<div id="neuKontaktInput">
							<%
								if (typ.equals("privat")) {
									out.println("<input name=\"vorname\" type=\"text\" size=\"30\" maxlength=\"30\" id=vorname value=\""
											+ name + "\">");
									out.println("<input name=\"nachname\" type=\"text\" size=\"30\" maxlength=\"30\" id=nachname value=\""
											+ name2 + "\" >");
								} else if (typ.equals("firma")) {
									out.println("<input name=\"firmenname\" type=\"text\" size=\"30\" maxlength=\"30\" id=vorname value=\""
											+ name + "\">");
									out.println("<input name=\"ansprechpartner\" type=\"text\" size=\"30\" maxlength=\"30\" id=nachname value=\""
											+ name2 + "\" >");
								}

								out.println("<input name=\"strasse\" type=\"text\" size=\"30\" maxlength=\"30\" id=strasse value=\""
										+ strasse + "\">");
								out.println("<input name=\"hausnummer\" type=\"text\" size=\"30\" maxlength=\"30\" id=hausnummer value=\""
										+ hausnummer + "\">");
								out.println("<input name=\"plz\" type=\"text\" size=\"30\" maxlength=\"30\" id=plz value=\""
										+ plz + "\">");
								out.println("<input name=\"ort\" type=\"text\" size=\"30\" maxlength=\"30\" id=ort value=\""
										+ ort + "\">");
								out.println("<input name=\"email\" type=\"E-Mail\" size=\"30\" maxlength=\"30\" id=kontaktEmail value=\""
										+ email + "\">");
								out.println("<input name=\"telefon\" type=\"text\" size=\"5\" maxlength=\"30\" id=telefon value=\""
										+ vorwahl + "\"> /");
								out.println("<input name=\"telefon2\" type=\"text\" size=\"17\" maxlength=\"30\" id=telefon2 value=\""
										+ telefonnummer + "\">");
							%>
						</div>
						<div id="oeffentlich">
				...
				<div id="sideBox">
					<div id="searchBox">
						<form action="BITTE NACHTRAGEN">
							...
							<input type="button" id="searchButton" name="search" value=""
