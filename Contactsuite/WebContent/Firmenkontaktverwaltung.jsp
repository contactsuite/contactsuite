	...
	<div id="mainFrame">
		...
		<div id="content">
			...
			<div id="mainContent">
				...
				for(Firmenkontakt  tmpKontakt : lstKontakt){

					if(farbig){
						out.println("<tr id=\"tabFarbig\"><td>");
						out.println(tmpKontakt.getFirmenname());
						out.println("</td><td>");
						out.println(tmpKontakt.getAnsprechpartner());
						out.println("</td><td>");
			...
			<div id="sideBox">
				...
				<div id="sideNavi">
						...
						<ul>
							<li><a href="Controller?fcode=FirmenkontaktAnlegen">Neuer Kontakt</a></li>
