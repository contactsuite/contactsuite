...
/**
 * Das Servlet Validierung ist für die Validierung von Registrierungsanfragen
 * zuständig. Es überprüft ob ein Nutzer mit der angegeben E-Mail Adresse
 * bereits im System existiert und ob das Passwort und die Passwortbestätigung
...
public class Validierung extends HttpServlet {
	...
	/**
	 * 
	 * Validierung von E-Mail Adresse und Passwort sowie Passwortbestätigung. Im
